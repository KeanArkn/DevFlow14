  ...
  return (
    <Sheet>
        <SheetTrigger asChild>
            <Image src='/assets/icons/hamburger.svg' alt='mobile navbar' width={36} height={36} className='invert-colors sm:hidden' />
        </SheetTrigger>
        ...
        <div className='no-scrollbar flex flex-col grow justify-between overflow-y-auto'>
            <SheetClose asChild>
                <NavContent />
            </SheetClose>
            <SignedOut>
